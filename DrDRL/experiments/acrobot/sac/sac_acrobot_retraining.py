...
from dr_drl.envs.acrobot.drift_params.sac import adaptable_env, non_adaptable_env
...
def main():
    ...
    for i in range(10):
        ...
        for j in range(6):
            ...
            env = Acrobot('acrobot-v0', discrete_action_space=False)
            ...
            agent_cl = SACAgent(obs_dim=obs_dim, act_dim=n_actions, act_lim=act_lim, discount=0.99, temperature=0.3,
                                ...
                                replay_start_size=10000, buffer_size=int(1e6), layer_names=None,
            ...
            # Set up runner
            continual_learning_runner = DrDRLRunner(env, agent=agent_cl,
                                                       train_episodes=300,
                                                       test_episodes=100,
